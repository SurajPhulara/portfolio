...
import "./Home.css"
import { bg1, bootstrap, cicon, cplusplus, css, designerIcon, developerIcon, figma, freelancerIcon, githubicon, html, js, linkedinicon, man, mongodb, muicon, nodejs, reacticon, resume, tailwind, uxicon } from '../../assets'
    ...
    <div className='home' id='home'>
      ...
      <div id="about-me" className='flex justify-between h-fit'>
        ...
        <div className="right flex flex-col justify-center gap-6  w-2/4">
          <div className="text-base text-xl font-semibold text-[#e88c09]">ABOUT ME</div>
          ...
          <div className="socialmedia flex items-center gap-16 ml-[-5px]">
            <a href="https://www.linkedin.com/in/suraj-phulara-b63b23193/" className="linkedin flex items-center gap-2 sm:gap-4 text-xl text-[#0078d4]"> <img src={linkedinicon} alt="linkedin" className='flex justify-start' /> <p className=' pt-2'>LinkedIn</p></a>
            <a href="https://github.com/SurajPhulara" className="github flex items-center gap-2 sm:gap-4 text-xl"><img src={githubicon} alt="github" /> <p className=' pt-2'>Github</p></a>
          </div>
        </div>
      </div>


      <div className="h-fit h-screen pl-[2vw] pt-[100px] pr-[2vw] text-center flex flex-col gap-8" id='skills'>
        <div className="text-base text-xl font-semibold text-[#e88c09]">MY SKILLS</div>
        <div className="flex gap-8 justify-center flex-wrap items-center">
          ...
          <SkillCards image={tailwind} name="TAILWIND CSS"></SkillCards>
          <SkillCards image={nodejs} name="NODE Js"></SkillCards>
          <SkillCards image={mongodb} name="mongoDB"></SkillCards>
          <SkillCards image={bootstrap} name="BOOTSTRAP"></SkillCards>
          <SkillCards image={githubicon} name="GITHUB"></SkillCards>
          <SkillCards image={cplusplus} name="C++"></SkillCards>
          <SkillCards image={cicon} name="C"></SkillCards>
        </div>
      </div>
    </div>
  )
